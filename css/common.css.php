...
padding: 0;
border: 0;
font-family: <?= $GLOBALS['cfg']['FontFamily']; ?>;
}
...
margin: 0;
margin-<?= $left; ?>: 240px;
color: <?= $GLOBALS['cfg']['MainColor']; ?>;
background: <?= $GLOBALS['cfg']['MainBackground']; ?>;
}
...
pre,
code {
font-family: <?= $GLOBALS['cfg']['FontFamilyFixed']; ?>;
}
<?php endif; ?>
...
color: <?= $GLOBALS['cfg']['ControlColor']; ?>;
cursor: pointer;
outline: none;
...
#initials_table a {
border: 1px solid #868687;
background: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>;
padding: 4px 8px;
-moz-border-radius: 5px;
-webkit-border-radius: 5px;
border-radius: 5px;
<?= $theme->getCssGradient('ffffff', 'e0e0e0'); ?>
}

#initials_table a.active {
border: 1px solid #666;
box-shadow: 0 0 2px #999;
<?= $theme->getCssGradient('bbbbbb', 'ffffff'); ?>
}
...
hr {
color: <?= $GLOBALS['cfg']['MainColor']; ?>;
background-color: <?= $GLOBALS['cfg']['MainColor']; ?>;
border: 0;
height: 1px;
}
...
color: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>;
background: #3e434a;
padding: 4px;
border-radius: 4px;
}
...
input.button {
margin: 6px 14px;
border: 1px solid <?= $GLOBALS['cfg']['ControlColor']; ?>;
padding: 3px 7px;
text-decoration: none;
cursor: pointer;
border-radius: 4px;
...
padding: 0.5em;
background: #383c42;
text-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px
#2b2b2b inset;
-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px
#2b2b2b inset;
-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px
#2b2b2b inset;
box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 2px #2b2b2b
inset;
}
...
-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px
#212121;
-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px
15px #212121;
box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>3px 3px 15px
#212121;
max-width: 100%;
}
...
/* buttons in some browsers (eg. Konqueror) are block elements, this breaks
design */
button {
display: inline;
}
...
div.tools a {
color: <?= $GLOBALS['cfg']['ControlColor']; ?> !important;
}
...
background: #484d56;
color: <?= $GLOBALS['cfg']['BrowseMarkerColor']; ?>;
}
...
*/
.condition {
border-color: <?= $GLOBALS['cfg']['BrowseMarkerBackground']; ?> !important;
}
...
.before-condition {
border-right: 1px solid <?= $GLOBALS['cfg']['BrowseMarkerBackground']; ?>;
}
<?php endif; ?>
...
overflow: hidden;
clip: inherit;
background-color: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>;
display: none;
border: 1px solid #000;
position: relative;
}
...
-moz-box-shadow: 0 1px 1px #44475a inset;
-webkit-box-shadow: 0 1px 1px #44475a inset;
box-shadow: 0 1px 1px #44475a inset;
}
...
font-weight: bold;
color: <?= $GLOBALS['cfg']['ThColor']; ?>;
background: <?= $GLOBALS['cfg']['ThBackground']; ?>;
}
...
background: <?= $GLOBALS['cfg']['ControlColor']; ?>;
color: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>;
}
...
ul#topmenu ul {
-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 6px
#026bb3;
-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px
#026bb3;
box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px
#026bb3;
}
...
/* background-color: <?= $GLOBALS['cfg']['MainBackground']; ?>; */
}

ul#topmenu2 a.tab:hover,
ul#topmenu2 a.tabactive {
background-color: <?= $GLOBALS['cfg']['BgOne']; ?>;
border-radius: .3em;
...
/* to be able to cancel the bottom border, use <li class="active"> */
	...
	/* border-bottom: 0pt solid <?= $GLOBALS['cfg']['MainBackground']; ?>; */
	border-right: 0;
	border-bottom-color: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>;
	}
	/* end topmenu */
	...
	overflow: visible;
	visibility: hidden;
	background-color: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>fcc;
	color: #006600;
	...
	margin: 0;
	padding: 3px;
	-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px
	#666;
	-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px
	3px #666;
	box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 3px #666;
	background-color: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>;
	z-index: 2;
	}
	...
	color: <?= $GLOBALS['cfg']['ThColor']; ?>;
	background: #f3f3f3;
	<?= $theme->getCssGradient('ffffff', 'cccccc'); ?>
	font-weight: bold;
	text-align: <?= $left; ?>;
	}
	...
	-webkit-border-radius: 5px;
	border-radius: 5px;
	-moz-box-shadow: 0 1px 2px <?= $GLOBALS['cfg']['HeadingsTextColor'] ?> inset;
	-webkit-box-shadow: 0 1px 2px <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>
	inset;
	box-shadow: 0 1px 2px <?= $GLOBALS['cfg']['HeadingsTextColor'] ?> inset;
	background: #555;
	color: #d4fb6a;
	}
	...
	-webkit-border-radius: 5px;
	-moz-border-radius: 5px;
	box-shadow: 0 1px 1px <?= $GLOBALS['cfg']['HeadingsTextColor'] ?> inset;
	-webkit-box-shadow: 0 1px 1px <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>
	inset;
	-moz-box-shadow: 0 1px 1px <?= $GLOBALS['cfg']['HeadingsTextColor'] ?> inset;
	}
	#sectionlinks a,
	.buttonlinks a,
	a.button {
	...
	<?= $theme->getCssGradient('f8f8f8', 'd8d8d8'); ?>
	}
	#sectionlinks a:hover,
	.buttonlinks a:hover,
	a.button:hover {
	<?= $theme->getCssGradient('ffffff', 'dddddd'); ?>
	}
	...
	/* main page */
	#maincontainer {
	/* background-image: url(<?= $theme->getImgPath('logo_right.png'); ?>); */
	...
	margin-left: -25px !important; //align with other list items which have
	bullets
	}
	...
	-webkit-border-radius: 4px;
	border-radius: 4px;
	-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px
	#121213;
	-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px
	5px #121213;
	box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px
	#121213;
	margin-bottom: 1em;
	padding-bottom: 1em;
	}
	...
	*/
	...
	z-index: 1100; /** If this is not kept at a high z-index, the jQueryUI modal
	dialogs (z-index: 1000) might hide this */
	text-align: center;
	display: inline;
	left: 0;
	right: 0;
	...
	*/
	...
	white-space: nowrap;
	text-decoration: none;
	border: 1px solid <?= $GLOBALS['cfg']['BgTwo']; ?>;
	...
	.config-form fieldset th,
	.config-form fieldset td {
	border-top: 1px <?= $GLOBALS['cfg']['BgTwo']; ?> solid;
	border-<?= $right; ?>: none;
	}
	...
	top: 55px;
	width: 100%;
	background: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>fff;
	}
	...
	.cPointer {
	background: url(<?= $theme->getImgPath('col_pointer.png'); ?>);
	height: 20px;
	...
	.tooltip * {
	background: none !important;
	color: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?> !important;
	}
	...
	.coldrop {
	background: url(<?= $theme->getImgPath('col_drop.png'); ?>);
	cursor: pointer;
	height: 16px;
	margin-<?= $left; ?>: .3em;
	margin-top: .3em;
	...
	background: #383c42;
	border-radius: 3px;
	border-top: 3px solid <?= $GLOBALS['cfg']['ControlColor']; ?>;
	position: absolute;
	...
	<?= $theme->getCssGradient('eeeeee', 'cccccc'); ?>
	}
	...
	height: 1.4em;
	width: 1.2em;
	text-shadow: 1px 0 <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>;
	}
	...
	<?= $theme->getCssGradient('333333', '555555'); ?>
	}
	...
	background: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>
	url(<?= $theme->getImgPath('ajax_clock_small.gif'); ?>) no-repeat right
	center;
	padding-<?= $right; ?>: 1.5em;
	}
	...
	background: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>
	url(<?= $theme->getImgPath('ajax_clock_small.gif'); ?>) no-repeat center;
	height: 10em;
	}
	...
	.saving_edited_data {
	background: url(<?= $theme->getImgPath('ajax_clock_small.gif'); ?>) no-repeat
	left;
	padding-<?= $left; ?>: 20px;
	}
	...
	.ui-tpicker-grid-label { background: none; border: none; margin: 0; padding:
	0; }
	...
	div#page_content div#tableslistcontainer, div#page_content div.notice,
	...
	border-color: <?= $GLOBALS['cfg']['HeadingsTextColor'] ?>;
	}
	...
	-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px
	5px #ccc;
	box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>2px 2px 5px #ccc;
	}
	...
	-moz-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 15px
	#999 inset;
	-webkit-box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px
	15px #999 inset;
	box-shadow: <?= $GLOBALS['text_dir'] === 'rtl' ? '-' : ''; ?>1px 1px 15px #999
	inset;
	}
	...
	span.drag_icon {
	display: inline-block;
	background-image: url('<?= $theme->getImgPath('s_sortable.png'); ?>');
	...
	background-image: url(<?= $theme->getImgPath('s_desc.png'); ?>);
	}

	th.headerSortDown .sorticon, th.headerSortUp:hover .sorticon {
	background-image: url(<?= $theme->getImgPath('s_asc.png'); ?>);
	}
